/*
    Controla el LED RGB inteligente WS2812B
...
#ifndef attiny13_WS2812B_h
#define attiny13_WS2812B_h
...
#if F_CPU != 9600000UL
#error "El WS2812B solo se puede usar con una frecuencia de reloj F_CPU de 9600000UL"
#endif
